...
class ProtomapTheme {
  ...
  static Theme basemapTheme({Logger? logger}) {
    final Map<String, dynamic> mapStyle =
        _protomapBasemapData(); // Obtain the map style data
    return ThemeReader(logger: logger)
        .read(mapStyle); // Use the ThemeReader to create a Theme
  }
}

Map<String, dynamic> _protomapBasemapData() {
  return {
    "version": 8,
    "sources": {
      "protomaps": {
