...
_$ThemeHillshadeLayerImpl _$$ThemeHillshadeLayerImplFromJson(
        Map<String, dynamic> json) =>
    _$ThemeHillshadeLayerImpl(
...
Map<String, dynamic> _$$ThemeHillshadeLayerImplToJson(
        _$ThemeHillshadeLayerImpl instance) =>
    <String, dynamic>{
