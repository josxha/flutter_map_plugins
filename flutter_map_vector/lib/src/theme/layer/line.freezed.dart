...
class _$ThemeLineLayerImpl implements _ThemeLineLayer {
  ...
  @override
  String toString() {
    return 'ThemeLineLayer(type: $type, id: $id, filter: $filter, layout: $layout, maxZoom: $maxZoom, minZoom: $minZoom, paint: $paint, slot: $slot, source: $source, sourceLayer: $sourceLayer)';
  }
...
abstract class _ThemeLineLayer implements ThemeLineLayer, ThemeLayer {
  const factory _ThemeLineLayer(
      ...
      final String? source,
      @JsonKey(name: 'source-layer')
      final String? sourceLayer}) = _$ThemeLineLayerImpl;
