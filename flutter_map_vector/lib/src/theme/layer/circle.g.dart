...
_$ThemeCircleLayerImpl _$$ThemeCircleLayerImplFromJson(
        Map<String, dynamic> json) =>
    _$ThemeCircleLayerImpl(
...
Map<String, dynamic> _$$ThemeCircleLayerImplToJson(
        _$ThemeCircleLayerImpl instance) =>
    <String, dynamic>{
