...
ThemeRasterLayer _$ThemeRasterLayerFromJson(Map<String, dynamic> json) {
  return _ThemeRasterLayer.fromJson(json);
}

/// @nodoc
mixin _$ThemeRasterLayer {
  ...
  @JsonKey(ignore: true)
  $ThemeRasterLayerCopyWith<ThemeRasterLayer> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ThemeRasterLayerCopyWith<$Res> {
  factory $ThemeRasterLayerCopyWith(
          ThemeRasterLayer value, $Res Function(ThemeRasterLayer) then) =
      _$ThemeRasterLayerCopyWithImpl<$Res, ThemeRasterLayer>;
  @useResult
  $Res call(
      {ThemeLayerType type,
      String id,
...
/// @nodoc
class _$ThemeRasterLayerCopyWithImpl<$Res, $Val extends ThemeRasterLayer>
    implements $ThemeRasterLayerCopyWith<$Res> {
  _$ThemeRasterLayerCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ThemeRasterLayerImplCopyWith<$Res>
    implements $ThemeRasterLayerCopyWith<$Res> {
  factory _$$ThemeRasterLayerImplCopyWith(_$ThemeRasterLayerImpl value,
          $Res Function(_$ThemeRasterLayerImpl) then) =
      __$$ThemeRasterLayerImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {ThemeLayerType type,
...
/// @nodoc
class __$$ThemeRasterLayerImplCopyWithImpl<$Res>
    extends _$ThemeRasterLayerCopyWithImpl<$Res, _$ThemeRasterLayerImpl>
    implements _$$ThemeRasterLayerImplCopyWith<$Res> {
  __$$ThemeRasterLayerImplCopyWithImpl(_$ThemeRasterLayerImpl _value,
      $Res Function(_$ThemeRasterLayerImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ThemeRasterLayerImpl(
      type: null == type
          ? _value.type
          : type // ignore: cast_nullable_to_non_nullable
              as ThemeLayerType,
...
/// @nodoc
@JsonSerializable()
class _$ThemeRasterLayerImpl implements _ThemeRasterLayer {
  const _$ThemeRasterLayerImpl(
      {required this.type,
      required this.id,
      this.filter,
      this.layout,
  ...
  factory _$ThemeRasterLayerImpl.fromJson(Map<String, dynamic> json) =>
      _$$ThemeRasterLayerImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ThemeRasterLayer(type: $type, id: $id, filter: $filter, layout: $layout, maxZoom: $maxZoom, minZoom: $minZoom, paint: $paint, slot: $slot, source: $source, sourceLayer: $sourceLayer)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ThemeRasterLayerImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ThemeRasterLayerImplCopyWith<_$ThemeRasterLayerImpl> get copyWith =>
      __$$ThemeRasterLayerImplCopyWithImpl<_$ThemeRasterLayerImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ThemeRasterLayerImplToJson(
      this,
    );
  }
}

abstract class _ThemeRasterLayer implements ThemeRasterLayer, ThemeLayer {
  const factory _ThemeRasterLayer(
      ...
      final String? source,
      @JsonKey(name: 'source-layer')
      final String? sourceLayer}) = _$ThemeRasterLayerImpl;

  factory _ThemeRasterLayer.fromJson(Map<String, dynamic> json) =
      _$ThemeRasterLayerImpl.fromJson;
