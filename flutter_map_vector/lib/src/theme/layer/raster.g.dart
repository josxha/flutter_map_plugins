...
_$ThemeRasterLayerImpl _$$ThemeRasterLayerImplFromJson(
        Map<String, dynamic> json) =>
    _$ThemeRasterLayerImpl(
...
Map<String, dynamic> _$$ThemeRasterLayerImplToJson(
        _$ThemeRasterLayerImpl instance) =>
    <String, dynamic>{
