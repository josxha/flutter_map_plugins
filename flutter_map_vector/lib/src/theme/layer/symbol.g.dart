...
_$ThemeSymbolLayerImpl _$$ThemeSymbolLayerImplFromJson(
        Map<String, dynamic> json) =>
    _$ThemeSymbolLayerImpl(
...
Map<String, dynamic> _$$ThemeSymbolLayerImplToJson(
        _$ThemeSymbolLayerImpl instance) =>
    <String, dynamic>{
