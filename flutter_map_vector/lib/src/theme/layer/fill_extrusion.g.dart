...
_$ThemeFillExtrusionLayerImpl _$$ThemeFillExtrusionLayerImplFromJson(
...
Map<String, dynamic> _$$ThemeFillExtrusionLayerImplToJson(
        _$ThemeFillExtrusionLayerImpl instance) =>
    <String, dynamic>{
